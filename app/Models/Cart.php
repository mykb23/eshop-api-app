...
class Cart extends Model
{
     ...
     *  @OA\Property(type="string", title="image", default="https://res.cloudinary.com/mykb/image/upload/v1643027274/e-com-app/images/products/default/no-image.png",property="image"),
    ...
    protected $fillable = ['product_name', 'product_price', 'image', 'quantity', 'user_id', 'product_id'];
